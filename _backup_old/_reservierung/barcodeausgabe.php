...
if (isset($barcode) && strlen($barcode)>0) {    
  ...
  if ($obj) {
     if ($obj->DrawObject($xres)) {
         echo "<table align='center'><tr><td align='center' id='off'><img src='./image.php?code=".$barcode."&style=".$style."&type=".$type."&width=".$width."&height=".$height."&xres=".$xres."&font=".$font."'></td></tr></table>";
