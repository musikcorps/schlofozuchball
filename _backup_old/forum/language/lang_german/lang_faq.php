...
$faq[] = array("Wie editiere oder lösche ich eine Umfrage?", "Genau wie bei den Beiträgen können Umfrage nur vom Verfasser, Forumsmoderator oder Administrator editiert oder gelöscht werden. Um eine Umfrage zu ändern, editiere den ersten Beitrag im Thema (die Umfrage ist immer damit verbunden). Wenn noch niemand bei der Umfrage teilgenommen hat, können User die Umfrage editieren oder löschen; falls jedoch schon jemand mit gestimmt hat, können sie nur Moderatoren oder Administratoren löschen oder editieren. Damit soll verhindert werden, dass Personen ihre Umfragen beeinflussen, indem sie die Antworten verändern.");
